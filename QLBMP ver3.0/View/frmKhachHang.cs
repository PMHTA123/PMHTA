...
namespace QL_BanHang.View
{
    public partial class frmKhachHang : Form
    {
        ...
        {
            dtgvDS.DataSource = khCtr.GetData();
            binding();
            DisEnl(false);
        }
        //hàm kết nối giao diện với dữ liệu
        ...
        // hàm load giới tính lên combobox
       ...
       // hàm xóa dũ liệu trong database
